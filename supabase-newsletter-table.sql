...
ON public."Newsletter" (email, source);
...
CREATE POLICY "Allow public newsletter signup" ON public."Newsletter"
    FOR INSERT 
    TO public 
    WITH CHECK (true);
...
CREATE POLICY "Restrict newsletter access" ON public."Newsletter"
    FOR ALL
    TO authenticated
    USING (false);
